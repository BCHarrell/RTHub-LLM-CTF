...
"""
Used for objective `admin-file-read`. This is part of a two-tool pair, this 
one reads files from the system-docs folder (initialized to 
game_files/admin-file-read/system-docs) to simulate elevated access.
